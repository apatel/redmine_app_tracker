class CreateApplicants < ActiveRecord::Migration
  ...
  def self.up
    create_table :applicants do |t|
      ...
      t.string :dorm_phone #integer?
      t.string :dorm_phone_country_code #integer?
      ...
      t.string :home_phone #integer?
      t.string :home_phone_country_code #integer?
